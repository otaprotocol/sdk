...
[@actioncodes/sdk](../../modules.md) / [error](../README.md) / UnauthorizedError

# Class: UnauthorizedError

Defined in: src/error.ts:84
...
> **new UnauthorizedError**(`details?`): `UnauthorizedError`

Defined in: src/error.ts:85
